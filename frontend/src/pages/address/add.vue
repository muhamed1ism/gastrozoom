    ...
    <v-row>
      <v-col cols="10" sm="8" md="6" lg="4"  offset="1" offset-sm="2" offset-md="3" offset-lg="4">
        ...
        <v-form @submit.prevent="submit">
          ...
          <v-row>
            <v-col cols="6">
              <v-text-field density="compact" placeholder="Home number" rounded
                            variant="outlined" v-model="form.addressNumber" class="" append-inner-icon="."/>
            </v-col>
            <v-col cols="6">
              <v-text-field density="compact" placeholder="Floor" rounded
                            variant="outlined" v-model="form.floorNumber" class="" append-inner-icon="."/>
            </v-col>
          </v-row>
          ...
          <v-btn type="submit" prepend-icon="mdi-plus" block variant="flat" color="primary" size="large" class="mb-8 mt-4" rounded>
            Add address
          </v-btn>
        </v-form>
