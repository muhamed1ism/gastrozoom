  ...
  <v-container fluid class="fill-height">
    <v-row>
      ...
      <v-col  cols="12" sm="8" md="6" lg="4" offset-sm="2" offset-md="3" offset-lg="4">
        <h4 class="text-h4 text-center font-weight-medium pb-12">Register</h4>
        <v-form @submit.prevent="submit">
          <v-text-field density="compact" placeholder="Name" prepend-inner-icon="mdi-account" rounded
                        variant="outlined" v-model="form.name" class="mb-1" append-inner-icon="."/>

          <v-text-field density="compact" placeholder="Phone number" prepend-inner-icon="mdi-phone" rounded
