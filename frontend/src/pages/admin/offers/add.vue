...
const submit = async () => {
  ...
  await foodStore.createFood(formData);
    ...
    <v-row class="pb-8">
      <v-col cols="12" sm="10" md="8" lg="6" offset-sm="1" offset-md="2" offset-lg="3" class="d-flex">
        ...
        <div class="d-flex align-center pl-6">
          <h1 class="text-h5 text-md-h4 font-weight-medium">Add offer</h1>
        </div>
      </v-col>
      <v-col cols="10" sm="8" md="6" lg="4" offset="1" offset-sm="2" offset-md="3" offset-lg="4">
        <v-icon size="8rem" class="text-center text-primary w-100 mb-8">mdi-food</v-icon>
